/**
 * Drift guard for the library version constant (mirrors surface-client #57).
 *
 * `ACCOUNT_CLIENT_VERSION` is codegen'd from `package.json` by
...
import { ACCOUNT_CLIENT_VERSION } from "../version.js";

describe("ACCOUNT_CLIENT_VERSION", () => {
  test("matches package.json version (no drift)", () => {
    expect(ACCOUNT_CLIENT_VERSION).toBe(pkg.version);
  });
});
