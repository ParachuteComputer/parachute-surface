// RFC 4180 CSV parser — hand-rolled to keep the bundle lean (a CSV-only dep
// like papaparse is ~45 KB minified for features we don't need).
//
// Handles:
...
export function parseCsv(input: string): ParsedCsv {
  ...
  // A single empty input shouldn't synthesize an empty row.
